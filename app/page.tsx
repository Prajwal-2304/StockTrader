  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        {message && (
          <Alert className="max-w-md mx-auto mt-16 mb-4">
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <Card className="bg-white/50 backdrop-blur-md dark:bg-gray-800/50">
                ...
                <CardContent>
                  <p className="text-gray-600 dark:text-gray-300">
                    Powerful tools for technical analysis, portfolio tracking, and risk assessment.
                  </p>
                </CardContent>
              </Card>
              <Card className="bg-white/50 backdrop-blur-md dark:bg-gray-800/50">
                ...
                <CardContent>
                  <p className="text-gray-600 dark:text-gray-300">
                    Trade and monitor stocks from markets around the world, all in one place.
                  </p>
                </CardContent>
                <Slider />
              </Card>
              ...
              {[
                {
                  ...
                  role: "Day Trader",
                  content:
                    "AlphaWealth has revolutionized my trading strategy. The real-time data and advanced analytics have given me a significant edge in the market.",
                },
                {
                  name: "Rakesh",
                  role: "Long-term Investor",
                  content:
                    "As a long-term investor, I appreciate the comprehensive market insights provided by AlphaWealth. It's helped me make more informed decisions for my portfolio.",
                },
                {
                  name: "Bhaskar",
                  role: "Financial Advisor",
                  content:
                    "I recommend AlphaWealth to all my clients. The platform's user-friendly interface and powerful tools cater to both novice and experienced investors.",
                },
